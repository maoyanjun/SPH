...
! Description: Introductory procedure for the main algorithm.     主要算法的介绍性程序               
!----------------------------------------------------------------------------------------------------------------------------------
...
! To create vtk file   sunjw 20170311
if (vtkconv) then
   prefix = nomecaso
