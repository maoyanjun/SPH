...
type TyGlobal
   ...
   integer(4)       :: icpoi_fr_points ! Monitoring point output frequency  !///add time series of points
   ...
   double precision :: dd ! dx: particle size     粒子尺度                        
   double precision :: trunc ! h/dx, h=dd*trunc   ！截断长度                      
   double precision :: PVolume ! dx^D, D: domain dimensionality   粒子体积                      
   double precision :: coefke  
   double precision :: coefkacl  
   double precision :: CFL ! CFL number                     
   double precision :: prif ! Reference presure      参考压力                     
   ...
   double precision :: cpoi_fr_points ! Output frequency for monitoring points
   ...
   double precision :: TetaP ! Partial smoothing parameter for pressure   压力部分平滑参数                      
   double precision :: TetaV ! Partial smoothing parameter for velocity     速度部分平滑参数                     
   double precision :: pre ! Reference pressure                            
   double precision :: h ! Kernel support length scale      光滑长度                        
   double precision :: start ! Simulation start time      开始时间                    
   double precision :: COEFNMAXPARTI ! Max number of fluid 最大粒子数
   ...
   double precision :: t0 ! Time at the beginning of the simulation 
                          ! (origin: beginning of the year)         开始计算时间                   
